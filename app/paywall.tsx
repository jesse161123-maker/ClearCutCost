...
const FEATURES = [
  {
    ...
    description: "Analyze as many documents as you need, every month",
  },
  {
    icon: "⚡",
    title: "Advanced AI Insights",
    description: "Deeper analysis with more detailed findings and recommendations",
  },
  {
    icon: "📤",
    title: "Export & Share",
    description: "Export analyses as PDF and share with advisors or contractors",
  },
  {
    icon: "🔒",
    title: "Priority Processing",
    description: "Faster analysis with priority AI processing",
  },
];
...
export default function PaywallScreen() {
  ...
  if (!isWeb && currentOffering) {
    return (
      <View style={styles.hostedPaywallContainer}>
        <RevenueCatUI.Paywall
          style={styles.hostedPaywall}
          options={{
        ...
        <SafeAreaView edges={["top", "bottom"]} style={styles.safeArea}>
          ...
          >
            ...
            <View style={styles.header}>
              ...
              {__DEV__ && (
                <Text style={styles.debugOfferingText}>
                  Offering: {currentOffering?.identifier ?? "none"} · Packages:{" "}
                  {packages.map((pkg) => pkg.identifier).join(", ") || "none"}
                </Text>
              )}
            </View>
